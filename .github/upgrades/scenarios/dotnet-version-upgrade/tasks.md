...
**Progress**: 2/5 tasks complete <progress value="40" max="100"></progress> 40%
**Status**: In Progress - Task 02-upgrade-solution

## Tasks
  - ✅ 02.03-app-and-tests: Upgrade Razor Pages application and tests ([Content](tasks/02.03-app-and-tests/task.md), [Progress](tasks/02.03-app-and-tests/progress-details.md))
